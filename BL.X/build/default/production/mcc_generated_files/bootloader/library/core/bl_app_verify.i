...
# 36 "mcc_generated_files/bootloader/library/core/bl_app_verify.c"
...
# 37 "mcc_generated_files/bootloader/library/core/bl_app_verify.c" 2
# 1 "C:\\Program Files\\Microchip\\xc8\\v3.10\\pic\\include\\c99/stdbool.h" 1 3
# 38 "mcc_generated_files/bootloader/library/core/bl_app_verify.c" 2
...
# 39 "mcc_generated_files/bootloader/library/core/bl_app_verify.c" 2
# 49 "mcc_generated_files/bootloader/library/core/bl_app_verify.c"
...
# 111 "mcc_generated_files/bootloader/library/core/bl_app_verify.c"
static bl_result_t CRC16_Validate(flash_address_t startAddress, uint32_t length, flash_address_t crcAddress)
{
    bl_result_t result = BL_FAIL;
    uint16_t crc = (0xFFFFU);
    _Bool refAddrInsideEvaluatedArea = (((crcAddress + 1U) >= startAddress) && (crcAddress < (startAddress + length)));
    _Bool refAddrOutsideFlash = ((crcAddress + 1U) >= (0x020000U));
...
bl_result_t BL_ImageVerify(void)
{
    ...
    result = (bl_result_t)CRC16_Validate((flash_address_t)(0x3000), (uint32_t)((((uint32_t)(0x1FFFF) - (2U)) + (uint32_t)1U) - (uint32_t)(0x3000)), (flash_address_t)(((uint32_t)(0x1FFFF) - (2U)) + (uint32_t)1U));
