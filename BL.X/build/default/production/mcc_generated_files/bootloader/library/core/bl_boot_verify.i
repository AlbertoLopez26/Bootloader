# 1 "mcc_generated_files/bootloader/library/core/bl_boot_verify.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 295 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "mcc_generated_files/bootloader/library/core/bl_boot_verify.c" 2
# 31 "mcc_generated_files/bootloader/library/core/bl_boot_verify.c"
# 1 "mcc_generated_files/bootloader/library/core/bl_boot_verify.h" 1
# 33 "mcc_generated_files/bootloader/library/core/bl_boot_verify.h"
...
# 36 "mcc_generated_files/bootloader/library/core/bl_app_verify.h" 2
# 1 "mcc_generated_files/bootloader/library/core/bl_config.h" 1
# 48 "mcc_generated_files/bootloader/library/core/bl_config.h"
...
# 49 "mcc_generated_files/bootloader/library/core/bl_config.h" 2
...
# 37 "mcc_generated_files/bootloader/library/core/bl_app_verify.h" 2
# 1 "mcc_generated_files/bootloader/library/core/bl_memory.h" 1
# 34 "mcc_generated_files/bootloader/library/core/bl_memory.h"
...
# 38 "mcc_generated_files/bootloader/library/core/../../../nvm/nvm.h" 2
...
# 34 "mcc_generated_files/bootloader/library/core/bl_boot_verify.h" 2
# 59 "mcc_generated_files/bootloader/library/core/bl_boot_verify.h"
bl_result_t CRC32_BOOT_Validate(flash_address_t startAddress, uint32_t length, flash_address_t refAddress);
# 32 "mcc_generated_files/bootloader/library/core/bl_boot_verify.c" 2
    ...
    for (byteIndex = 0U; byteIndex < length; byteIndex++)
    {
        ...
        *crcSeed ^= (uint32_t) readByte;
        ...
        for (uint8_t bit = 8U; bit > 0U; --bit)
        {
            if ((*crcSeed & 0x01U) != 0U)
            {
                *crcSeed = (*crcSeed >> 1U) ^ (0xEDB88320U);
            }
            else
            {
                *crcSeed >>= 1U;
...
# 99 "mcc_generated_files/bootloader/library/core/bl_boot_verify.c"
bl_result_t CRC32_BOOT_Validate(flash_address_t startAddress, uint32_t length, flash_address_t refAddress)
{
    bl_result_t result = BL_FAIL;
    uint32_t crc = (0xFFFFFFFFU);

    _Bool refAddrInsideEvaluatedArea = (((refAddress + 3U) >= startAddress) && (refAddress < (startAddress + length)));
    _Bool refAddrOutsideFlash = ((refAddress + 3U) >= (0x020000U));

    if ((0U == length) || ((startAddress + length) > (0x020000U)))
    {
...
# 136 "mcc_generated_files/bootloader/library/core/bl_boot_verify.c"
        if (refCRC != crc)
        {
