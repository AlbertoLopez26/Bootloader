	...
	; Compiler options:
	;
	; -q --opt=none --chip=18f47q43 \
	; --dfp=C:\Program Files\Microchip\MPLABX\v6.30\packs\Microchip\PIC18F-Q_DFP\1.28.451\xc8 \
	; --codeoffset=0x3000 --rom=3000-1FFFD --addrqual=require \
	; --runtime=-config --std=c99 --output=+inhx32 -Mdist/APP_TEST.map \
	; -oAPP_TEST.hex --objdir=dist --outdir=dist main.c \
	; -L--fixupoverflow=error --rors --icl=auto --callgraph=none --warn=-3 \
